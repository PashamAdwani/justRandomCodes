# -*- coding: utf-8 -*-
"""
Created on Thu Jan 17 11:52:10 2019
...
#    CI_Out.append(out1)          
#  
#def convert_array(input_img):  
#    in_a = np.((1000, x, y, c))
#    for index in range(len()):
#        in_a[index] = input_img[dex]
#        
Input_Images=np.zeros((1536,128,128,1)) 
Output_Images=np.zeros((1536,128,128,1))      
##==========
for i in range(len(cropped_images1)):
    Input_Images[i]=cropped_images1[i].reshape((128,128,1))
    Output_Images[i]=cropped_images2[i].reshape((128,128,1))
    #print(i)
##==========        
...
aCI_1 = np.asarray(cropped_images1).reshape((1,-1))
aCI_Out = np.asarray(cropped_images2).reshape((1,-1))
print(aCI_1.shape, aCI_Out.shape, type(cropped_images1), type(aCI_1))
#x=CI_1[0].reshape(128,128,1)
#y=CI_Out[0].reshape(128,128,1)
model.fit(Input_Images[0:1530],Output_Images[0:1530])
x=model.predict(Input_Images[1531:1536])